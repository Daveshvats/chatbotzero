...
$sendToEmail = 'vatsdavesh@gmail.com'; // Email address that will receive the message with the output of the form
$sendToName = 'Ghost'; // Name that will receive the message with the output of the form
...
$okMessage = 'We have received your inquiry. Stay tuned, we will get back to you very soon.';
